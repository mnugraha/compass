...
@section('title')
    Compentency C - Compass Indorama
@endsection
...
@section('konten-tanpa-frame')
            ...
            <div style="overflow-x:auto;">
                <table class="table table-striped table-responsive">
                    <tr style="background-color: goldenrod">
                        <th class="text-center" style="color: black">Structure / Point</th>
                        @for ($i = 1; $i <= 5; $i++)
                            <th class="text-center" style="color: black; ">{{ $i }}
                                @if ($i == 1)
                                    <br> {{ 'No Evidence' }}
                                @elseif($i == 2)
                                    <br> {{ 'Developing' }}
    ...
    <a href="/C_en" class="btn btn-default btn-icon-fixed" style="box-shadow: -1px 2px 3px #888888"><span
