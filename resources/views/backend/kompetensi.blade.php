...
@section('konten')
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title"><span class="icon-user"></span> Tambah Data Kompetensi</h3>
        </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-11">
                            ...
                            <textarea name="definisi" cols="60" rows="3"></textarea>
                        </div>
                    </div>
                </div>
        </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <textarea name="definisi" cols="40" rows="5">{{ $x->definisi }}</textarea>
                                        </div>
                                    </div>
                                </div>
